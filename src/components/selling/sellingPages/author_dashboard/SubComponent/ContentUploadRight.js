...
function ContentUploadRight() {
    ...
    const [category, setCategory] = useState(sellCategory)
            ...
            <div className="category">
                ...
                <div className="upload_item_div">
                    ...
                    <div className="select_category">
                        ...
                        <button className='primary_btn' onClick={handleSwitchCategory}>Switch Category &nbsp;&nbsp;&nbsp;<ImArrowRight/></button>
                    </div>
                </div>
            </div>
...
export default ContentUploadRight